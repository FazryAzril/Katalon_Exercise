...
WebUI.setText(findTestObject('Object Repository/1.User_Management/Add_New_account/Create_user_admin/Page_OrangeHRM/input'), 
    RandomStringUtils.random(7, 'abcdefghijklmnopqrstuvwxyz'))
...
WebUI.verifyElementText(findTestObject('1.User_Management/Add_New_account/Unregistered_User/Page_OrangeHRM/span_Required'), 
    'Required')
