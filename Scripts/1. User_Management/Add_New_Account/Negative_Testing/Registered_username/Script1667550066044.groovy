...
WebUI.setText(findTestObject('1.User_Management/Add_New_account/Create_user_admin/Page_OrangeHRM/Username_Input'), GlobalVariable.Admin_username)

WebUI.setEncryptedText(findTestObject('1.User_Management/Add_New_account/Create_user_admin/Page_OrangeHRM/Password_Input'), 
    'TxG0S2S+VkIKkWMkFey6Uw==')

WebUI.setEncryptedText(findTestObject('1.User_Management/Add_New_account/Create_user_admin/Page_OrangeHRM/Confirm_Password_Input'), 
    'TxG0S2S+VkIKkWMkFey6Uw==')

WebUI.click(findTestObject('1.User_Management/Add_New_account/Create_user_admin/Page_OrangeHRM/button_Save'))

WebUI.verifyElementText(findTestObject('New_user/Unregistered_User/Page_OrangeHRM/span_Already exists'), 'Already exists')
