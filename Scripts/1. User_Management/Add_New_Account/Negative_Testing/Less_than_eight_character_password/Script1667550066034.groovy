...
WebUI.setEncryptedText(findTestObject('New_user/Create_user_admin/Page_OrangeHRM/Password'), 'ha13LK61cJM=')

WebUI.setEncryptedText(findTestObject('New_user/Create_user_admin/Page_OrangeHRM/Confirm Password'), 'ha13LK61cJM=')

WebUI.click(findTestObject('Object Repository/New_user/Unregistered_User/Page_OrangeHRM/button_Save'))

WebUI.verifyElementText(findTestObject('New_user/Unregistered_User/Page_OrangeHRM/span_Should have at least 8 characters'), 
